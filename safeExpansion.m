function safeExpansion(start, goal, Cobs, l, w)
...
while cont 
    ...
    if isempty(qNext1) == 0
        ...
        path1(k1, :) = qNext1;
        plot([path1(k1-1, 1) qNext1(1)], [path1(k1-1, 2), qNext1(2)], 'b--', "LineWidth", 2)
        hold on
    ...
    if eps11 < 0.1 && eps21 < 0.1
           ...
           plot([path1(k1-1, 1) goal(1)], [path1(k1-1, 2), goal(2)], 'b--', "LineWidth", 2)
